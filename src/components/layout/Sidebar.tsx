...
import { LayoutTemplate, Zap, CheckCircle, FileSpreadsheet, PackageOpen } from "lucide-react";
...
const navItems = [
  ...
  { id: "shopee"   as ActiveView, label: "Template Shopee",  shortLabel: "Shopee",   icon: FileSpreadsheet, description: "Excel Mass Upload" },
  { id: "ziptoshopee" as ActiveView, label: "Import ZIP → Shopee", shortLabel: "Import ZIP", icon: PackageOpen, description: "ZIP lama → Excel Shopee" },
];
